...
// **********************************************************************************
// Using the 193-byte Vendor-Specific descriptor for G600
// **********************************************************************************
const uint8_t our_report_descriptor_g600[] = {
...
const our_descriptor_def_t our_descriptors[] = {
    ...
    {
        .idx = 6,
        .descriptor = our_report_descriptor_g600,
        .descriptor_length = sizeof(our_report_descriptor_g600),
        .vid = 0x046D, // Logitech VID
        .pid = 0xC24A, // G600 PID
        .handle_received_report = do_handle_received_report,
        // For advanced functionality, you would create and assign functions like this:
        // .handle_set_report = g600_handle_set_report,
        // .handle_get_report = g600_handle_get_report,
    },
};
