...
// Interface 0: Mouse (Idêntico ao G600)
const uint8_t g600_mouse_report_descriptor[72] = {
...
// Interface 1: Teclado + Macros/Vendor (38 bytes + 193 bytes = 231 bytes)
const uint8_t g600_intf1_report_descriptor[231] = {
  // --- Teclado ---
