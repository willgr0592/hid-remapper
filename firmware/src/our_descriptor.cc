...
const uint8_t our_report_descriptor_kb_mouse[] = {
    // Descriptor Mouse - must match desc_ms_mouse in tinyusb_stuff.cc and
    // uart_fake_descriptor in uart_cmd.cc. Report ID 1 payload is:
    // [buttons+pad][x16][y16][wheel8][pan8] = 7 bytes.
    ...
    // Descriptor Keyboard (Modified from G600 to change Report ID 1 to 2) - 38 bytes
